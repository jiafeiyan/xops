        ...
        table_sqls = dict(
            ...
            SZSEPosition=dict(columns=("InvestorID", "BusinessUnitID", "MarketID", "ShareholderID", "TradingDay",
                              ...
                              sql="""SELECT t1.InvestorID AS InvestorID,t1.InvestorID AS BusinessUnitID,
                                    ...
                                    AND t.SettlementGroupID = %s""",
                              params=(self.settlementGroupID,)),
            SZSEShareholderAccount=dict(columns=("ExchangeID", "ShareholderID", "MarketID", "TradingCodeClass",
                                                 "InvestorID", "TradingCodeEx", "PbuID", "BranchID",
                                                 "bProperControl", "TradingRightTemplateID"),
                                        sql="""SELECT '2' AS ExchangeID,t.ClientID AS ShareholderID,'2' AS MarketID,'a' AS TradingCodeClass,
