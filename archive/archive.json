{
    ...
    },
    {
        ...
        "items" : [{
          "basedir" :"${HOME}",
          "sources" : "run/dbsync/log/*.log.* run/hx_adapter/log/*.log.* run/ssecffexmdserver/log/*.log.* run/ssecffexoffer/log/*.log.* run/szsecffexmdserver/log/*.log.* run/szsecffexoffer/log/*.log.* run/tinit/log run/tradeserver/log/*.log.*",
