...
class trans_stockinfo_dbf:
    ...
    def __initETF(self, mysqlDB):
        self.logger.info("初始化50ETF和300ETF")
        ...
        sql = """INSERT INTO siminfo.t_tradingsegmentattr ( SettlementGroupID, TradingSegmentSN, TradingSegmentName, 
                              StartTime, InstrumentStatus, DayOffset, InstrumentID )
                  VALUES( %s,%s,%s,%s,%s,%s,%s )"""
        mysqlDB.executemany(sql, (("SG01", "1", "开盘前", "06:00:00", "0", "0", "510050"),
                                  ("SG01", "2", "非交易", "09:15:00", "1", "0", "510050"),
                                  ("SG01", "3", "集合竞价报单", "09:15:00", "3", "0", "510050"),
                                  ("SG01", "4", "集合竞价撮合", "09:25:00", "5", "0", "510050"),
                                  ("SG01", "5", "非交易", "09:30:00", "1", "0", "510050"),
                                  ("SG01", "6", "连续交易", "09:30:00", "2", "0", "510050"),
                                  ("SG01", "7", "非交易", "11:30:00", "1", "0", "510050"),
                                  ("SG01", "8", "连续交易", "13:00:00", "2", "0", "510050"),
                                  ("SG01", "9", "非交易", "15:03:00", "1", "0", "510050"),
                                  ("SG01", "10", "收盘", "15:03:00", "6", "0", "510050")))
        mysqlDB.executemany(sql, (("SG01", "1", "开盘前", "06:00:00", "0", "0", "510300"),
                                  ("SG01", "2", "非交易", "09:15:00", "1", "0", "510300"),
                                  ("SG01", "3", "集合竞价报单", "09:15:00", "3", "0", "510300"),
                                  ("SG01", "4", "集合竞价撮合", "09:25:00", "5", "0", "510300"),
                                  ("SG01", "5", "非交易", "09:30:00", "1", "0", "510300"),
                                  ("SG01", "6", "连续交易", "09:30:00", "2", "0", "510300"),
                                  ("SG01", "7", "非交易", "11:30:00", "1", "0", "510300"),
                                  ("SG01", "8", "连续交易", "13:00:00", "2", "0", "510300"),
                                  ("SG01", "9", "非交易", "15:03:00", "1", "0", "510300"),
                                  ("SG01", "10", "收盘", "15:03:00", "6", "0", "510300")))
        sql = """insert into siminfo.t_marginrate (SettlementGroupID, MarginCalcID,. InstrumentID, ParticipantID)
                  VALUES(%s,%s,%s,%s)"""
        mysqlDB.execute(sql, ("SG01", "0001", "510050", "00000000"))
        mysqlDB.execute(sql, ("SG01", "0001", "510300", "00000000"))
        sql = """insert into siminfo.t_marginratedetail(SettlementGroupID,TradingRole,HedgeFlag,ValueMode,
                                                        LongMarginRatio,ShortMarginRatio,AdjustRatio1,AdjustRatio2,
                                                        InstrumentID,ParticipantID,ClientID)
                      values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)"""
        mysqlDB.execute(sql, ("SG01", "1", "1", "1", "1.000000", "1.000000", "", "", "510050", "00000000", "00000000"))
        mysqlDB.execute(sql, ("SG01", "1", "1", "1", "1.000000", "1.000000", "", "", "510300", "00000000", "00000000"))
...
if __name__ == '__main__':
    ...
    # 启动stock脚本
    trans_stockinfo_dbf(context=context, configs=conf)
