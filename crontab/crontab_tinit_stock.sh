...
sh ${SIM_PLATFORM_HOME}/appshell/stock/stop_etf_broker.sh >> crontab.log

# 2) shutdown stock broker
echo "start stop_stock_broker.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/stop_stock_broker.sh >> crontab.log

# 3) shutdown stock exchange
echo "start stop_stock_exchange.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/stop_stock_exchange.sh >> crontab.log
...
sh ${SIM_PLATFORM_HOME}/appshell/stock/trans_etfinfo.sh >> crontab.log

# 7) trans_stockinfo.sh
echo "start trans_etfinfo.py ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/trans_stockinfo.sh >> crontab.log

# 8) toSyncAll.sh
echo "start toSyncAll.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/toSyncAll_stock.sh >> crontab.log

# 9) stock_csv_all.sh
echo "start stock_csv_all ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/stock_csv_all.sh >> crontab.log

# 10) etf_csv_all.sh
echo "start stock_csv_all ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/etf_csv_all.sh >> crontab.log

# 11) tinit.sh
echo "start tinit.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/tinit_stock.sh >> crontab.log

# 12) start stock exchange
echo "start start_stock_exchange.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/start_stock_exchange.sh >> crontab.log

# 13) start stock broker
echo "start start_stock_broker.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/start_stock_broker.sh >> crontab.log

# 14) start etf broker
echo "start start_etf_broker.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/stock/start_etf_broker.sh >> crontab.log
