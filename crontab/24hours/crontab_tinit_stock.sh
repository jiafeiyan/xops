...
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/stop_etf_broker.sh >> crontab.log

# 2) shutdown stock broker
echo "start stop_stock_broker.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/stop_stock_broker.sh >> crontab.log

# 3) shutdown stock exchange
echo "start stop_stock_exchange.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/stop_stock_exchange.sh >> crontab.log
...
python ${SIM_PLATFORM_HOME}/datatrans/sync_all_prepare_data.py >> crontab.log

# 7) trans_etfinfo.sh
echo "start trans_etfinfo.py ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/trans_etfinfo.sh >> crontab.log

# 7) trans_stockinfo.sh
echo "start trans_etfinfo.py ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/trans_stockinfo.sh >> crontab.log

# 8) toSyncAll.sh
echo "start toSyncAll.sh ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/toSyncAll_stock.sh >> crontab.log

# 9) stock_csv_all.sh
echo "start stock_csv_all ... "
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/stock_csv_all.sh >> crontab.log
...
sh ${SIM_PLATFORM_HOME}/appshell/${SIM_RELEASE}/stock/start_stock_broker.sh >> crontab.log
